...
Lien vers le [rapport FastQC r1](https://github.com/gaelcastel/EvaluationM4M5/tree/master/QC/SRR10390685_1_fastqc.html) et [rapport FastQC r2](https://github.com/gaelcastel/EvaluationM4M5/tree/master/QC/SRR10390685_2_fastqc.html)
...
|---------------------------------------------|:------:| --------------------------------------------------------------:|
| --length_required                           |   36   | La section "Overrepresented sequences" du fastqc des reads 1   |
|                                             |        | indique une séquence surreprésentée de 35 nucléotides non      |
|                                             |        | identifiés "N". Comme les reads font majoritairement autour de |
|                                             |        | 150 bp, on va éliminer tous les reads dont la longueur est in- |
|                                             |        | férieure à 36 bp pour éliminer ces séquences de 35 "N", sans   |
|                                             |        | risquer d'éliminer des reads d'intérêt.                        |
|                                             |        |                                                                |
| --cut_tail                                  |   NA   | Le programme va lire les reads depuis l'extrémité 3' pour dé-  |
|                                             |        | terminer s'ils seront conservés ou éliminés selon des critères | 
|                                             |        | de qualité définis (cf ci-dessous).                            |
|                                             |        |                                                                |
| --cut_window_size                           |    8   | Le programme va lire les reads par morceaux de 8 bp            | 
|                                             |        |                                                                |
| --cut_mean_quality                          |   28   | La section "Per sequence quality scores" du fastqc montre que  | 
|                                             |        | le très grande majorité des séquences ont un score > 28. On va |
|                                             |        | donc éliminer celles dont le score est < 28, en considérant    |
|                                             |        | qu'ils sont de qualité médiocre, et qu'ils ne représentent     |
|                                             |        | qu'une part négligeable des reads totaux. Ce paramètre est en- |
|                                             |        | utilisé en coopération avec --cut_tail et --cut_window_size 8. |
|                                             |        | Ainsi, le programme va parcourir le read depuis l'extrémité 3' |
|                                             |        | (--cut_tail) par fenêtre de 8 bp (--cut_window_size 8) en les  |
|                                             |        | éliminant si leur score de qualité moyen est < 28.             |
...
````
<img src="./images/igv.png" alt="IGV visualisation of trmNF overlapping reads">

## MultiQC

Le rapport MultiQC, qui récapitule la majorité des points que nous avons abordés, est consultable ici : [rapport MultiQC](https://github.com/gaelcastel/EvaluationM4M5/tree/master/QC/multiqc_report.html)
